        ...
        <form method="POST" action='ContestsController' name="frmAddContest">
            <table border="0" style="padding: 3px;">
                <tr>
                    ...
                    <td style="width: 250px;"><input type="text" readonly="readonly" name="contest_id" value="<c:out value="${contest.ID}" />" /></td>
                </tr>
                <tr>
                    <td style="text-align: right; width: 150px;">Contest Name :</td>
                    <td style="width: 250px;"><input type="text" name="contestName" value="<c:out value="${contest.contestName}" />" /></td>
                </tr>
                <tr>
                    <td style="text-align: right; width: 150px;">Start Date :</td>
                    <td style="width: 250px;"><input type="text" name="contestStartDate" value="<c:out value="${contest.startDate}" />" /></td>
                </tr>
                <tr>
                    <td style="text-align: right; width: 150px;">End Date :</td>
                    <td style="width: 250px;"><input type="text" name="contestEndDate" value="<c:out value="${contest.endDate}" />" /></td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                </tr>
